...
public class Secant extends AppCompatActivity {
        ...
        hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(x0.getText().toString().trim().length() == 0){
                    Toast.makeText(Secant.this, "x0 atau x1 tidak boleh kosong !", Toast.LENGTH_SHORT).show();
                }
    ...
    public void sekan(){
        ...
        for(int i=0; i < Nmaks; i++)
        {
            ...
            //x3 + 2x2 + 15x - 5
            fa = (Math.pow(a,3)) + 2 * (Math.pow(a,2)) + (15 * a ) - 5;
            fb = (Math.pow(b,3)) + 2 * (Math.pow(b,2)) + (15 * b ) - 5;
