...
public class Keempat extends AppCompatActivity {
        ...
        hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(x0.getText().toString().trim().length() == 0){
                    Toast.makeText(Keempat.this, "x0 atau x1 tidak boleh kosong !", Toast.LENGTH_SHORT).show();
                }
    ...
    public void sekan(){
        ...
        for(int i=0; i < Nmaks; i++)
        {
            ...
            //4x3 - 15x2 + 17x - 6
            fa = (4 * Math.pow(a,3)) + (15 * (Math.pow(a,2))) + (17 * a ) - 6;
            fb = (4 * Math.pow(b,3)) + (15 * (Math.pow(b,2))) + (17 * b ) - 6;
