...
public class Kedua extends AppCompatActivity {
        ...
        hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(x0.getText().toString().trim().length() == 0){
                    Toast.makeText(Kedua.this, "x0 atau x1 tidak boleh kosong !", Toast.LENGTH_SHORT).show();
                }
    ...
    public void sekan(){
        ...
        for(int i=0; i < Nmaks; i++)
        {
            ...
            //x3 + 2x2 + 15x - 5
            fa = ( 3 * Math.pow(a,3)) + 5 * (Math.pow(a,2)) + (5 * a ) - 20;
            fb = ( 3 * Math.pow(b,3)) + 5 * (Math.pow(b,2)) + (5 * b ) - 20;
